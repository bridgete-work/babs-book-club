  ...
  return (
    <div className="skater-girl" aria-hidden="true">
      ...
      >
        ...
        {/* Hair — long blonde flowing behind */}
        <path
          d="M46 22 C36 18 26 22 22 35 C20 42 22 55 26 60 C30 65 34 62 36 58 C38 54 38 48 40 44 C42 40 44 36 46 32 Z"
          fill="#f0d060"
        />
        {/* Top of hair */}
        <path
          d="M48 14 C52 10 68 10 72 14 C76 18 74 22 72 24 C68 20 52 20 48 24 C46 22 44 18 48 14 Z"
          fill="#f0d060"
        />
        {/* Hair strand flying back */}
        <path
          d="M47 18 C40 16 30 20 26 28 C22 36 24 48 28 54"
          stroke="#f0d060"
          strokeWidth="5"
          strokeLinecap="round"
          fill="none"
        ...
        {/* Glasses — Quinn from Daria */}
        <rect x="50" y="23" width="10" height="7" rx="2" stroke="#1a1a1a" strokeWidth="1.5" fill="none" />
        <rect x="62" y="23" width="10" height="7" rx="2" stroke="#1a1a1a" strokeWidth="1.5" fill="none" />
        <line x1="60" y1="26.5" x2="62" y2="26.5" stroke="#1a1a1a" strokeWidth="1.5" />
